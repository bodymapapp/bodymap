    ...
    if (sendEmail && booking.client_email) {
      ...
      const resendRes = await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          ...
          subject: `Your massage on ${dateStr} at ${timeStr}. Please fill your intake form`,
          html: emailHtml,
        }),
      });
