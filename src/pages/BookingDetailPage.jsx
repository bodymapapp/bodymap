...
export default function BookingDetailPage({ therapist }) {
  ...
  return (
    <div>
      ...
      {/* HK Jun 2 2026: the page-rail was retired. DetailPanel (page mode)
          now owns the full-width two-column layout itself, so the booking
          identity, Session, tags, cadence, Setup, and Client details live in
          its left column with their handlers intact (no cross-file rewire).
          Client details + Notes are passed in as props. */}
      <DetailPanel
        appt={appt}
        therapist={therapist}
        mode="page"
