...
export default function Privacy() {
  const items = [
    { title: '1. Who We Are', body: 'BodyMap LLC is a Wyoming limited liability company operating mybodymap.app. Contact us at bodymapdemo@gmail.com.' },
    ...
    { title: '6. Client Data', body: 'Therapists are responsible for informing clients that intake data is stored digitally. Clients may request deletion by contacting their therapist or emailing bodymapdemo@gmail.com. We process requests within 30 days.' },
    ...
    { title: '8. Your Rights (CCPA)', body: 'California residents have the right to know what data we collect, request deletion, and opt out of data sale (we do not sell data). Contact bodymapdemo@gmail.com.' },
