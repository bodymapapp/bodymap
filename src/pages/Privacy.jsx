...
export default function Privacy() {
  const items = [
    ...
    { title: '5. Data Sharing', body: 'We do not sell, rent, or share your phone number, email address, or any personal data with third parties for marketing purposes. Phone numbers collected for SMS messaging are used solely to deliver appointment reminders, confirmations, and follow-ups via the MyBodyMap platform. We share data only with: Supabase (hosting), Stripe (payments), Resend (email delivery), and Twilio (SMS delivery). All providers are contractually bound to protect your data and process it only on our behalf. SMS opt-in data and consent records are not shared with third parties.' },
    { title: '5a. SMS Messaging', body: 'When you provide your phone number to your massage therapist through their MyBodyMap booking page, you consent to receive transactional SMS messages including: booking confirmations, appointment reminders (typically 24-48 hours before your appointment), intake form links, post-session follow-ups, and gentle re-engagement messages if you have not booked recently.\n\nMessage frequency: SMS volume varies based on your booking activity and your therapist\'s notification preferences. Typical frequency is 2 to 5 messages per booked appointment.\n\nMessage and data rates may apply. Standard carrier rates from your mobile provider apply to all SMS sent and received.\n\nOpt-out: You may unsubscribe at any time by replying STOP to any message. Replying HELP returns contact information for support. SMS phone numbers and opt-in consent records are never sold or shared with third parties.' },
