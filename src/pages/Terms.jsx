...
export default function Terms() {
  const items = [
    ...
    { title: '6. SMS Communications', body: 'When you provide your phone number on a MyBodyMap booking page or therapist signup form and check the consent box, you agree to receive SMS messages from your therapist via the MyBodyMap platform. These may include appointment reminders, booking confirmations, post-session follow-ups, and re-engagement messages. Therapist accounts may also receive product updates, onboarding tips, and account messages from MyBodyMap directly.\n\nMessage frequency varies based on your booking activity (typically 2-6 messages per month per therapist relationship). Message and data rates may apply, charged by your mobile carrier. We do not charge for SMS.\n\nYou can opt out at any time by replying STOP to any message. After opting out, you will receive one final confirmation message and no further texts. To re-subscribe, reply START. For help, reply HELP or email support@mybodymap.app.\n\nWe will never sell your phone number, share it with third parties for marketing, or use it for purposes outside the booking and communication features of the platform. SMS data is not used to train AI or shared across therapist accounts.' },
