    ...
    <>
      ...
      <div style={{
        ...
        <div className="print-doc" style={{
          ...
          {/* Branded header. Therapist-specific. We deliberately
              avoid MyBodyMap branding here, this is the THERAPIST's
              document, not ours. ABMP/AMTA attribution lives at the
              bottom of the footer, small and professional. */}
          <div style={{
          ...
          {/* Footer. Therapist-specific contact line + small
              attribution. No MyBodyMap link, no MyBodyMap branding,
              this is the therapist's document. */}
          <div style={{
