...
// HK May 27 2026: Cal was extracted to src/components/MonthCalendar.jsx
// so the bulk session scheduler (and eventually every date picker,
// per BLOCK_PLAN) shares one monthly grid. This thin wrapper keeps the
// existing <Cal .../> call sites in this file working unchanged.
function Cal(props) {
