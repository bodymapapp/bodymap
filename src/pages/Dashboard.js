...
function SettingsPanel({ therapist, lapsedDays, setLapsedDays }) {
  ...
  // Search alias map (HK Jun 12 2026 rebuild). Maps the everyday words a
  // therapist types to the taxonomy number of the setting that answers them.
  // Settings search is alias-driven, so every setting must be reachable here.
  // Numbers verified against the live section list. Many words map to more
  // than one section on purpose.
  const SEARCH_ALIASES = React.useMemo(() => ({
    ...
    acuity:         ['1.2'],
    mindbody:       ['1.2'],
    'existing clients': ['1.2'],
    'client list':  ['1.2'],
    // 1.3 Booking & intake links
    link:           ['1.3'],
    'booking link': ['1.3'],
    qr:             ['1.3'],
    'qr code':      ['1.3'],
    ...
    'out of office':['1.5'],
    unavailable:    ['1.5'],
    // 2.1 Services & hours (incl. mobile / client location)
    service:        ['2.1'],
    services:       ['2.1'],
    menu:           ['2.1'],
    hours:          ['2.1'],
    ...
    notification:   ['3.4', '3.3'],
    notifications:  ['3.4', '3.3'],
    'email alerts': ['3.4'],
    email:          ['3.4'],
    reminder:       ['3.4', '3.3'],
    reminders:      ['3.4', '3.3'],
    alert:          ['3.3', '3.4'],
    alerts:         ['3.3', '3.4'],
    // 3.5 Lapsed client threshold
    lapsed:         ['3.5'],
    inactive:       ['3.5'],
    dormant:        ['3.5'],
    'win back':     ['3.5'],
    threshold:      ['3.5'],
    // 4.1 / 4.1.5 calendar syncs
    cal:            ['4.1'],
    'cal.com':      ['4.1'],
    google:         ['4.1.5'],
    'google calendar': ['4.1.5'],
    gcal:           ['4.1.5'],
    calendar:       ['4.1.5', '4.1'],
    sync:           ['4.1.5', '4.1'],
    // 4.2 Payments + 4.2.1 routing
    payment:        ['4.2', '4.2.1'],
    payments:       ['4.2', '4.2.1'],
    pay:            ['4.2', '2.1'],
    stripe:         ['4.2', '4.2.1'],
    square:         ['4.2', '4.2.1', '1.2'],
    processor:      ['4.2.1'],
    routing:        ['4.2.1'],
    card:           ['4.2', '4.2.1'],
    'card on file': ['4.2.1'],
    ...
    payout:         ['4.2'],
    money:          ['4.2', '5.1'],
    // 4.3 Client agreements
    agreement:      ['4.3'],
    agreements:     ['4.3'],
    'booking policies': ['4.3'],
    policy:         ['4.3'],
    policies:       ['4.3'],
    cancellation:   ['4.3'],
    cancel:         ['4.3'],
  ...
  return (
    <div style={{ width: '100%' }}>
      ...
      <CollapsibleSection
        ...
        taxonomy="5.1"
        label="Your plan"
        summary={`${planTier(therapist)} · ${planPrice(therapist)}`}
        status="done"
        icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"><rect x="3" y="6" width="18" height="13" rx="2"/><path d="M3 11h18M7 15h3"/></svg>}
        isOpen={openRow === 'plan'}
        onToggle={toggleRow}
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div>
            <p style={{ fontSize: '18px', fontWeight: '700', color: C2.darkGray, margin: '0 0 4px 0' }}>
              {`${planTier(therapist)} - ${planPrice(therapist)}`}
            </p>
