...
const SEED_LINES = [
  ...
  { key: "anthropic", category: "Infrastructure", label: "Anthropic Claude API", monthly_cost: null, status: "active", notes: "Practice assistant drafts (SOAP, recap, summaries). Variable by usage. HK to confirm current monthly burn.", source: "chat: bodymap-ai edge function, draft-note mode" },
