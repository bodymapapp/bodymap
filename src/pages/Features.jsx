          ...
          <FadeIn>
            <div>
              ...
              <h2 style={{ fontFamily:"Georgia, serif", fontSize:"clamp(28px,3vw,44px)", fontWeight:700, color:C.dark, lineHeight:1.2, marginBottom:20 }}>
                Clients Show You What They Need.<br/>Before They Walk In.
              </h2>
              <p style={{ fontSize:16, color:C.gray, lineHeight:1.7, marginBottom:32 }}>
                No more verbal back-and-forth. No more forgotten preferences. Clients tap a body map on their phone in 30 seconds — front and back — marking exactly where to focus and what to avoid. Medical flags surface automatically.
              </p>
              <div style={{ display:"flex", flexDirection:"column", gap:10, marginBottom:32 }}>
                {["No app download — just a link","Works on any phone in under 30 seconds","Medical flags surface automatically before you start","Pressure, music, temperature, draping — all saved once, forever"].map((f,i)=>(
              ...
              <Link to="/demo" style={{ display:"inline-block", background:C.forest, color:"#fff", padding:"14px 28px", borderRadius:50, fontSize:15, fontWeight:600, textDecoration:"none" }}>
                Try Client Intake Now →
              </Link>
            </div>
          </FadeIn>
          <FadeIn delay={0.15}>
        ...
        <div style={{ maxWidth:1100, margin:"0 auto", display:"grid", gridTemplateColumns:"1fr 1fr", gap:80, alignItems:"center" }}>
          <FadeIn>
            <div>
              ...
              <h2 style={{ fontFamily:"Georgia, serif", fontSize:"clamp(28px,3vw,44px)", fontWeight:700, color:C.dark, lineHeight:1.2, marginBottom:20 }}>
                Know Exactly What<br/>You're Earning.<br/>Every Day.
              </h2>
              <p style={{ fontSize:16, color:C.gray, lineHeight:1.7, marginBottom:32 }}>
                Expected vs. actual revenue side by side — every session, every day, every week. See your collection rate, outstanding payments, and top clients by revenue. Daily, weekly, yearly views and business insights to grow.
              </p>
              <div style={{ display:"flex", flexDirection:"column", gap:10, marginBottom:32 }}>
                {["Expected vs. actual revenue on every session","Collection rate tracking (industry avg: 82%)","Outstanding payment alerts — never lose track","Top clients by revenue with trend analysis","Yearly revenue chart showing your practice growth","Stripe Connect for direct client payments (coming soon)"].map((f,i)=>(
                  <div key={i} style={{ display:"flex", alignItems:"flex-start", gap:10, fontSize:15, color:C.dark }}>
                    <div style={{ width:20, height:20, borderRadius:"50%", background:"#DCFCE7", color:"#16A34A", display:"flex", alignItems:"center", justifyContent:"center", fontSize:12, flexShrink:0, marginTop:1 }}>✓</div>
                    {f}
                  </div>
          ...
          <FadeIn delay={0.15}>
            <div>
              <BillingDemo />
              <div style={{ textAlign:"center", marginTop:10, fontSize:12, color:C.gray }}>↑ Toggle Daily, Weekly, Yearly, and Insights</div>
            </div>
          </FadeIn>
        </div>
      </section>
