        ...
        <div style={{ maxWidth:1100, width:'100%', display:'grid', gridTemplateColumns:'1fr 1fr', gap:64, alignItems:'center' }} className="bm-home-hero-grid">
          <div>
            ...
            <div style={{ display:'flex', gap:12, flexWrap:'wrap', marginBottom:20 }}>
              ...
              <a href="https://mybodymap.app/book/bodymapdemopractice" target="_blank" rel="noreferrer" style={{ background:'transparent', color:G.mid, border:`2px solid ${G.mid}`, borderRadius:12, padding:'15px 28px', fontSize:15, fontWeight:700, textDecoration:'none', display:'inline-block' }}>
                See How It Works →
              </a>
            </div>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:64, alignItems:'center', minHeight:360 }} className="bm-home-feature-grid">
            <div>
              ...
              <div style={{ display:'flex', gap:10, flexWrap:'wrap' }}>
                ...
                <a href="https://mybodymap.app/book/bodymapdemopractice" target="_blank" rel="noreferrer" style={{ background:'transparent', color:G.mid, border:`2px solid ${G.mid}`, borderRadius:10, padding:'13px 20px', fontSize:14, fontWeight:700, textDecoration:'none', display:'inline-block' }}>
                  Try Live Demo →
                </a>
              </div>
            </div>
