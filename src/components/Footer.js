    ...
    <footer style={{ background: "#1A2F23", color: "white", padding: "48px 24px 32px" }}>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div className="bm-footer-grid" style={{ display: "flex", justifyContent: "space-between", flexWrap: "wrap", gap: "32px", marginBottom: "40px" }}>
          ...
          <div>
            <p style={{ fontWeight: "700", fontSize: "13px", textTransform: "uppercase", letterSpacing: "0.5px", marginBottom: "12px", color: "rgba(255,255,255,0.5)" }}>Connect</p>
            <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
              <a href="https://www.instagram.com/mybodymap01/" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,0.75)", textDecoration: "none", fontSize: "14px", display: "inline-flex", alignItems: "center", gap: 6 }}>
              ...
              <a href="https://www.facebook.com/profile.php?id=61568064032135" target="_blank" rel="noopener noreferrer" style={{ color: "rgba(255,255,255,0.75)", textDecoration: "none", fontSize: "14px", display: "inline-flex", alignItems: "center", gap: 6 }}>
