...
export default function SettingsHero({ therapist }) {
  ...
  return (
    <div className="bm-settings-hero" style={{
      ...
      {/* Booking + intake links are surfaced inside Section 1.3
          (the dedicated dashboard row) instead of at the top of the
          hero, after HK feedback that the prominent hero card felt
          oversized and the Preview button on it opened the wrong
          page. See Dashboard.js, section 1.3 'Booking & intake links'. */}
