...
`.trim();
      ...
      setMessages([{
        role: 'assistant',
        content: `Hi ${therapist.full_name?.split(' ')[0] || 'there'}! 👋 I'm BodyMap AI. I have access to your full practice data — ${(clients || []).length} clients, ${totalSessions} sessions. Ask me anything about your clients, schedule, revenue, or practice trends.`,
        timestamp: Date.now()
      }]);
    } catch (err) {
  ...
  return (
    <div style={{ width: '100%', display: 'flex', flexDirection: 'column', height: '70vh', minHeight: 500 }}>
      ...
      <div style={{ marginBottom: 16, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          <h2 style={{ fontFamily: 'Georgia, serif', fontSize: 26, fontWeight: 700, color: '#1F2937', margin: '0 0 2px 0' }}>BodyMap AI</h2>
          <p style={{ fontSize: 13, color: '#6B7280', margin: 0 }}>Your practice intelligence assistant — powered by your real client data</p>
        </div>
