  ...
  const dispatch = {
    ...
    product_update: () => ({
      ...
      body: [
        `Hi ${name},`,
        ``,
        `Joy from MyBodyMap. We rebuilt the platform for you this month, with one quiet goal in mind: give you back the hours you keep giving everyone else.`,
        ``,
        ...
        ``,
        `3. How you rest easier. Platform features quietly read every client's history before they walk in. Practice Pulse sends you a calm 6 PM digest of your day. Reminders go out automatically by text and email. Lapsed client alerts so no one slips away. Push notifications for new bookings. Notification preferences in your hands. Sage Platform chat with full client history when you need to remember a detail.`,
        ``,
        `4. Your membership. Bronze stays free for life with five sessions per client. Silver at $19 a month is unlimited everything. Gold adds white-glove onboarding. All three include the visual body map, brief, longitudinal pattern intelligence, full SOAP notes, and the secure HIPAA-encrypted vault. Cancel anytime.`,
        ``,
