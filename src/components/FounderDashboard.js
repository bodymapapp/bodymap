...
function buildActionFor(actionType, t) {
  ...
  const dispatch = {
    ...
    product_update: () => ({
      ...
      button: "Send",
      subject: `${name}, your dashboard is ready`,
      body: [
        `Hi ${name},`,
        ``,
        ...
        ``,
        `Your booking page works the moment you sign in. No setup hours required.`,
        ``,
        `If you have five minutes, take a peek and let us know what feels off.`,
        ``,
