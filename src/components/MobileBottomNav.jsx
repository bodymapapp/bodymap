...
const MORE_ITEMS = [
  ...
  { id: 'ai',       label: 'MyBodyMap Platform', sub: 'Ask anything about your practice', emoji: '🌿', gradient: 'linear-gradient(135deg,#F0FDF4,#DCFCE7)', border: '#86EFAC' },
...
export default function MobileBottomNav({ active, onChange, unreadCount, onSignOut, therapist }) {
  ...
  // Hide MyBodyMap Platform item when the therapist has turned Platform features off
