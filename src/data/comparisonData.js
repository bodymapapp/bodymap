...
export const CATEGORIES = [
  {
    ...
    rows: [
      ...
      { f: "Booking approval workflow (manual approve)", bm:"yes", mb:"tbc", vg:"yes", gg:"tbc", ac:"tbc", mi:"yes", no:"tbc" },
  ...
  },
  {
    ...
    rows: [
      ...
      { f: "Medical history / pregnancy / meds",         bm:"planned", mb:"yes", vg:"yes", gg:"yes", ac:"yes", mi:"yes", no:"yes" },
