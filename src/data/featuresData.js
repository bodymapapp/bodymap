  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        meta: "Bank-grade encryption · Private to you",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        body: [
          "Same encryption your bank uses. Only you see your clients.",
          "Hosted on a SOC 2 Type II audited platform. Each therapist's data is fully isolated.",
          "<em>A note on HIPAA:</em> most solo therapists aren't HIPAA-covered unless billing insurance. We're working on the formal paperwork either way.",
        ],
        meta: "Bank-grade encryption · SOC 2 Type II host",
      },
    ],
  },
  {
