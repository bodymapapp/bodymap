...
export const NOTIFICATION_SPEC = [
  ...
  },
  {
    ...
    when: 'A client completes the hosted checkout for one of your memberships',
    why: 'High-value, sticky revenue. Confirms the funnel works and triggers your follow-up workflow.',
    audience: 'therapist',
    channels: ['app_alert', 'push', 'email'],
    series: 'T',
  },
  {
    ...
    title: 'Membership renewing in 7 days',
    when: 'A client membership has current_period_end within 7 days',
    why: 'Heads-up so you can confirm payment, update the plan, or reach out before the auto-charge.',
    audience: 'therapist',
