...
export const NOTIFICATION_SPEC = [
  ...
  // ─── T-series: therapist journey ───────────────────────────────
  {
    ...
    why: 'So you know to expect them and can prep. Essential for solo practice.',
    audience: 'therapist',
  ...
  },
  {
    ...
    why: 'Real-time visibility into your revenue. Helps you reconcile day-of without checking the dashboard.',
    audience: 'therapist',
    channels: ['app_alert', 'push', 'email'],
    series: 'T',
  },
