...
0. **LEGAL + INSURANCE PROTECTION (Priority 0, week of May 24 2026, ~$2,500 year 1 + $1,500/year ongoing).** Triggered by the May 23-24 Candice incident: if she had not been gracious, she could have filed a claim for lost business or data loss. LLC alone is not enough. Six layers in priority order, do them this week before any new feature work:
    ...
    - **0.3 Terms of Service tightening.** Have a small-business attorney review existing ToS for these specific clauses ($500-1,000 one-time): limitation of liability (cap at fees paid in last 12 months), no consequential damages (kills "lost business" claims), AS-IS warranty disclaimer, mandatory arbitration + class action waiver (JAMS or AAA), forum selection in Texas, 30-day notice/cure period before claims, customer's responsibility to maintain own backups, one-way indemnification. If current ToS has all of these, skip. If missing any, update.
